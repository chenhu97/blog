...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	<jsp:include page="__checklogin.jsp"></jsp:include>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<title>易卓博客 - 会员系统 - 类目管理 - 添加类目</title>
...
<div class="content">
	...
	<div class="container-fluid">
		...
		<form id="tab" action="ArticleCat" method="post"> 
			...
			<div>
				<label>类目名称</label>
				<input type="text" name="catName" value="${catName}"class="input-xlarge" />
			</div>
			<div>
