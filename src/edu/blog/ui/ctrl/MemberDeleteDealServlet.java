 ...
 */
@WebServlet("/member_delete_deal.do")
public class MemberDeleteDealServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (result > 0) {
			out.println("<script>alert('删除成功。');location.href='member_list.do';</script>");
		}else {
			out.println("<script>alert('删除失败。');location.href='member_list.do'</script>");
		}
