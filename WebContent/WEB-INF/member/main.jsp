				...
				<div class="block span6">
					...
					<div id="widget1container" class="block-body collapse in">
						...
						<p>The layout.erb file includes the header, footer, and side
							...
							files.</p>
						<p>If you aren't using Ruby, there is also a set of plain HTML
							files for each page, just like you would expect.</p>
					</div>
				</div>
			</div>
				...
				<div class="block span6">
					...
					<div class="block-body">
						...
						<p>Fava bean jícama seakale beetroot courgette shallot
							...
							broccoli brussels sprout bitterleaf groundnut cress sweet pepper
							leek bok choy shallot celtuce scallion chickpea radish pea
							sprouts.</p>
						<p>
